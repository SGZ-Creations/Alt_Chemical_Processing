...
if mods["space-age"] and mods["bobenemies"] then
	...
	if SS["bobmods-enemies-enableartifacts"] and SS["bobmods-enemies-enablenewartifacts"] then
		...
		table.insert(DRR["biter-egg"].results, {type= "item", name="alien-artifact-orange", amount=5})
		table.insert(DRR["biter-egg"].results, {type= "item", name="alien-artifact-yellow", amount=5})
		table.insert(DRR["biter-egg"].results, {type= "item", name="alien-artifact-green", amount=5})
		table.insert(DRR["biter-egg"].results, {type= "item", name="alien-artifact-blue", amount=5})
		table.insert(DRR["biter-egg"].results, {type= "item", name="alien-artifact-purple", amount=5})
